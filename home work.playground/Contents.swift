...
for i in 0..<cart.count {
    print("-------------------------\(i+1)-------------------------")
    print("Назва товару: \(cart[i].productName)")
    print("Процессор: \(cart[i].processor)")
}
print("----------------------------------------------------")
...
while counter < cart.count {
    print("-------------------------\(counter+1)-------------------------")
    print("Назва товару: \(cart[counter].productName)")
    print("Ціна: \(cart[counter].price) ₴")
...
repeat {
print("---------------\(index+1)---------------")
print("Назва товару: \(cart[index].productName)")
